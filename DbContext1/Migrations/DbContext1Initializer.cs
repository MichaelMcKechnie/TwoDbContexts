...
using System.Linq;
using TwoDbContexts.DbContext1;
using TwoDbContexts.DbContext1.Db;
using TwoDbContexts.DbContext1.Migrations;

namespace SupplierReporting.AppServerUtilities.Db
{
    /// <summary>
    ...
    /// </summary>
    public class DbContext1Initializer : IDatabaseInitializer<DbContext1Database>
    {
        private readonly string _connection;

        public DbContext1Initializer(string connection)
        {
            Contract.Requires(!string.IsNullOrEmpty(connection), "connection");
            _connection = connection;
        }

        public void InitializeDatabase(DbContext1Database context)
        {
            Contract.Requires(context != null, "context");

            var configuration = new DbContext1MigrationsConfiguration()
            {
